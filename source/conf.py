...
# -*- coding: utf-8 -*-
#
# Organilab documentation build configuration file, created by
# sphinx-quickstart on Mon Aug  8 11:04:51 2016.
#
...
htmlhelp_basename = 'Organilabdoc'
...
latex_documents = [
    (master_doc, 'Organilab.tex', 'Organilab Documentation',
     'Solvo', 'manual'),
]
...
man_pages = [
    (master_doc, 'organilab', 'Organilab Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Organilab', 'Organilab Documentation',
     author, 'Organilab', 'One line description of project.',
     'Miscellaneous'),
]
